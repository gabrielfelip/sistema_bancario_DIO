...
def criar_usuario(usuarios):
    ...
    data_nascimeto = input("Informe da data de nascimento (dd-mm-aaaa): ")
    endereco = input("Informe o endereço (logradouro, nro - bairro - cidade/sigla estrado): ")

    usuarios.append({"nome": nome, "data_nascimento": data_nascimeto, "cpf": cpf, "endereco": endereco})

    print("==== Usuário cadastrado com sucesso! ====")
        
def filtar_usuario(cpf, usuarios):
    usuaros_filtrados = [usuario for usuario in usuarios if usuario["cpf"]==cpf]
    return usuaros_filtrados[0] if usuaros_filtrados else None
